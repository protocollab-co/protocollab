...
[![protocollab-octapi - Lua generator demo](https://img.shields.io/badge/protocollab--octapi-demo-blue?logo=github)](https://github.com/protocollab-co/protocollab-octapi)
...
**protocollab-octapi** — демонстрационный проект, реализующий генерацию Lua-кода для MWS Octapi с использованием компонентов `protocollab`. Репозиторий: [github.com/protocollab-co/protocollab-octapi](https://github.com/protocollab-co/protocollab-octapi)
