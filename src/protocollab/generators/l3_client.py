"""Python L3 socket-client generator for `protocollab`."""
...
class L3ClientGenerator(BaseGenerator):
    """Generate a Python TCP socket client for a protocol parser."""
    ...
    def generate(self, spec: Dict[str, Any], output_dir: Path) -> List[Path]:
        ...
        output_file = output_dir / f"{proto_id}_l3_client.py"
        ...
        template = env.get_template("l3_client.py.j2")
